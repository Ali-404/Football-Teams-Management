...
export default function Login() {
  ...
  return (
    <AnimatedContainer className='flex min-h-dvh bg-slate-100 '>
      
      {/* img */}
      <div className='bg-slate-600 flex-1 hidden md:flex bg-[url(images/1.jpeg)] bg-cover shadow-lg backdrop-blur rounded-tr-xl rounded-br-xl flex-col p-5'>
